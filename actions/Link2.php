...
class Link2 extends CController
{
	...
	protected function doAction(): void
	{
	  ...
	  #print_r($usuario);
	  # Exemplo de link usando dados da sessão do usuário
	  # Example of a link using user session data
	  $link = 'https://'. $url . '/link2/?session=' . $usuario['userid'];
